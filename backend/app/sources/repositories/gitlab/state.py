...
def load_watched_gitlab_repository_entities(subscription_id: str) -> tuple[Entity, ...]:
    """Load watched GitLab repository entities for one subscription."""
...
def describe_watched_gitlab_repositories(subscription_id: str) -> list[dict[str, object]]:
    ...
    repositories = load_watched_gitlab_repository_entities(subscription_id)
    return [
        {
