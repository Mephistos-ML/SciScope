...
def build_repository_candidate_signal(candidate: RepositoryCandidate) -> RawSignal:
    ...
    return RawSignal(
        ...
        source_type=f"{candidate.source}_repository",
        ...
        payload={
            "signal_kind": f"{candidate.source}_repository",
...
def build_repository_entity(raw_signal: RawSignal) -> Entity:
    """Build a monitored repository entity from an admitted raw signal."""
...
def build_repository_release_signal(release: RepositoryRelease) -> RawSignal:
    ...
    return RawSignal(
        ...
        source_type=f"{release.source}_release",
        ...
        payload={
            "signal_kind": f"{release.source}_release",
...
def read_repository_name(entity: Entity) -> str | None:
    """Read a normalized repository full name from one entity."""
